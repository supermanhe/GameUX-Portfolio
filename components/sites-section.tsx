  ...
  return (
    <div className="space-y-6">
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {items.map((site, i) => (
          <GsapReveal key={site.id} delay={i * 0.06}>
            <button
            ...
            >
              <div className="overflow-hidden rounded-lg border border-border/70 bg-card/80 transition duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-1 hover:border-primary/45">
                <SkeletonImage
                  src={site.cover}
                  alt={site.name}
                  fill
